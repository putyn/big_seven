...
d_t ntp_get_time() {
  ...
  //debug info
  Serial.print("IP from pool: ");
  Serial.println(ntp_server_ip.toString());
  ...
  //debug info
  Serial.println("Got NTP packet, setting the time");
  //read the packet
  ...
  //seconds since 1970 unix time + time zone
  epoch = sec_since1900 - seventy_years + 7200;
